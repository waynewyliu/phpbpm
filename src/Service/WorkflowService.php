...
{
    public static function initProcess($definationId, $userId, $name, $description)
    {
        //TODO:输入参数处理,current_step_id NULL值处理
        //进程创建时验证
        //根据定义创建进程
        $defination = WorkflowDefination::find($definationId);
//        DB::transaction(function () {

        $process = WorkflowProcess::create([
            'name' => $name,
            'description' => $description,
            'workflow_defination_id' => $definationId,
